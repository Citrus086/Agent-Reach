...
> 🍊 **本分支自定义功能**：保留 [Boss直聘](#支持的平台) 检测 | 新增 [`agent-reach update`](#更新) 命令 | [查看更新文档](docs/update.md)
...
| 💼 **Boss直聘** | — | 职位搜索、登录态检查、向 HR 打招呼 | 本分支保留，官方已移除 |
...
使用本分支新增的 `agent-reach update` 命令，自动合并上游更新并保留 Boss直聘等自定义功能：
